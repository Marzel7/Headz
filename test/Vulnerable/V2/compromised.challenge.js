...
describe("Compromised challenge", function () {
  ...
  before(async function () {
    ...
    const AttackExchange = await ethers.getContractFactory("AttackExchangeOracle", attacker);
    ...
    this.attackExchange = await AttackExchange.deploy(this.exchange.address, this.oracle.address);
  });
