...
contract TheRewarderPool {
    ...
    // Token deposited into pool by users
    DamnValuableToken public immutable liquidityToken;

    // Token used for internal accouting and snapshots
    ...
    function _hasRetrievedReward(address account) private view returns (bool) {
        return (lastRewardTimestamp[account] >= lastRecordedSnapshotTimestamp &&
            lastRewardTimestamp[account] <=
