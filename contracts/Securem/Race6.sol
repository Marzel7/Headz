...
contract Race6 is ERC721Enumerable, Ownable, ReentrancyGuard, VRFConsumerBase {
    ...
    uint256 public RESERVED_CONTRIBUTORS_AMOUNT;
    uint256 public MAX_FUTURE_LANDS;
    ...
    constructor(
        ...
        for (uint256 i; i < _contributors.length; ++i) {
            // contributors is a mapping
            contributors[_contributors[i].contributor] = _contributors[i] //__contributors is an array of typye ContributorAmount
                .amount; //  ContributorAmount is a struct containing
            tempSum += _contributors[i].amount; // address contributor, uint256 amount;
        }
